...
opts.expDir = 'data/fcn8s_addTrain-MCCAI2009' ;%edited by mR
opts.dataDir = 'data/MCCAI2009' ;
opts.modelPath = 'data/fcn8s_addTrain-MCCAI2009/net-epoch-100.mat' ;%edited by mR
...
%   if mod(i - 1,30) == 0 || i == numel(val)
    ...
    diary(fullfile('data/fcn8s_addTrain-MCCAI2009', 'info.txt')); 
