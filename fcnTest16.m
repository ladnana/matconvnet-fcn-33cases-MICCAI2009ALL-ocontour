...
opts.expDir = 'data/fcn16s-500-33cases_MICCAI2009' ;
opts.dataDir = 'data/33cases_MICCAI2009' ;
opts.modelPath = 'data/fcn16s-500-33cases_MICCAI2009/net-epoch-500.mat' ;
...
%   if mod(i - 1,30) == 0 || i == numel(val)
    ...
    diary(fullfile('data/fcn16s-500-33cases_MICCAI2009', 'info.txt')); 
