...
filters = single(bilinear_u(4, 1, 2)) ;%21->3 edited by mR
...
net.params(f).value = zeros(1, 1, 256, 2, 'single') ;%21->3 edited by mR
...
filters = single(bilinear_u(16, 2, 2)) ;%21->3 edited by mR
