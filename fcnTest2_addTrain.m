...
opts.expDir = 'data/fcn2s_addTrain-500-MCCAI2009' ;%edited by mR
opts.dataDir = 'data/MCCAI2009' ;
opts.modelPath = 'data/fcn2s_addTrain-500-MCCAI2009/net-epoch-500.mat' ;%edited by mR
...
%   if mod(i - 1,30) == 0 || i == numel(val)
    ...
    diary(fullfile('data/fcn2s_addTrain-500-MCCAI2009', 'info.txt')); 
