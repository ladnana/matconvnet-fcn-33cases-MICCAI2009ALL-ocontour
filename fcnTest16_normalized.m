...
opts.expDir = 'data/fcn16s_normalized-MCCAI2009' ;
opts.dataDir = 'data/MCCAI2009' ;
opts.modelPath = 'data/fcn16s_normalized-MCCAI2009/net-epoch-50.mat' ;
...
%   rgb = rgb{1} ;
  ...
  % Accumulate errors
  ok = lb > 0 ;
  confusion = confusion + accumarray([lb(ok),pred(ok)],1,[3 3]) ;
