...
opts.expDir = 'data/fcn8s-500-33cases_MICCAI2009' ;%edited by mR
opts.dataDir = 'data/33cases_MICCAI2009' ;
opts.modelPath = 'data/fcn8s-500-33cases_MICCAI2009/net-epoch-500.mat' ;%edited by mR
...
%   if mod(i - 1,30) == 0 || i == numel(val)
    ...
    diary(fullfile('data/fcn8s-500-33cases_MICCAI2009', 'info.txt')); 
